...
out.print("&emsp;&emsp;<td><figure><img src='./DisplayImage?imgid="+l+"' width='250px' height='400px'/><figcaption><br><a href='movieSelect.jsp?mName="+l+"'>"+l+"</figcaption></figure></td>");
line++;
}
out.print("</tr></table>");
